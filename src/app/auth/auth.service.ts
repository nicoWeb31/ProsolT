...
export class AuthService {
 ...
 getJwtToken() {
  ...
  console.log(`getJwtToken : ${localStorage.getItem(this.JWT_TOKEN)}`)
}
...
private storeRefrehToken(refresh_token: string) {
...
refreshToken() {
  ...
  return this.http.post<any>(this.urlSigin,body).pipe(tap((tokens: Tokens) => {
    this.storeJwtToken(tokens.access_token);
    this.storeRefrehToken(tokens.refresh_token);
...
private getRefreshToken() {
  ...
  console.log('getRefreshToken() : '+ localStorage.getItem(this.REFRESH_TOKEN))
}
